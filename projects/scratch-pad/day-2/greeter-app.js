...
function greeter(hour) {
    ...
    //used >, <=, and && to pass through what ever hour is given and assort it accordingly 
    if (hour >= 0 && hour <= 11) {
        //set hour >= 0 and less than equal to 11 for "Good Morning!" call
        console.log("Good Morning!");
    } else if (hour > 11 && hour <= 16) {
        //esle if hour > 11 and <= 16 so the times between 11 & 16 show "Good Afternoon!"
        console.log("Good Afternoon!");
    } else if (hour > 16 && hour <= 21) {
        console.log("Good Evening!");
    } else {
        console.log("Good Night!");
        //final esle is for all other times which are going to be higher than 21 or lower than 0 will say "Good Night!"
    }
